<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommonParameterManager.ascx.cs" Inherits="UserControls_CommonParameterManager" %>
<%@Register TagPrefix="CC" Namespace="LegoWeb.Controls"%>
<table width="100%" cellpadding="2" cellspacing="2" border="0">
<tbody>
<tr>
<td valign="middle" align="right"><b>Nhóm tham số:</b></td>
<td valign="middle" align="right" width="510px" >
    <asp:RadioButtonList ID="rdlParamType" runat="server" 
        ...
        <asp:ListItem Value="0">Chưa phân loại</asp:ListItem>
        <asp:ListItem Value="1">Đăng ký&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
        <asp:ListItem Value="2">Xử lý&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
        <asp:ListItem Value="3">Từ điển&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</asp:ListItem>
    </asp:RadioButtonList>
</td>
<td valign="middle" style="width:100px" align="left">
   <asp:Button ID="cmdSearch" class="searchbutton" runat="server" Text="&nbsp;Lọc&nbsp;" onclick="cmdApply_Click" />
</td>
</tr>
</tbody>
</table>
<table class="adminlist" cellspacing="1">   									
					<asp:repeater id="commonparameterManagerRepeater" runat="server" OnItemCommand="commonparameterManagerDataCommand" OnItemDataBound="commonparameterManagerItemDataBound">
							...
							<th width="10%" class="title">Tên tham số</th>							
							<th width="25%" class="title">Giá trị tiếng Việt</th>
        					<th width="25%" class="title">Giá trị tiếng Anh</th>
							<th width="30%" class="title">Mô tả</th>
							</tr>
							</thead>
							<tbody>
							</HeaderTemplate>
