...
namespace LegoWeb.DataProvider
{
    ...
    public class CategoryDataProvider: IDisposable
    {
        ...
        public int get_Search_Count(out int outPageCount, int iCategoryId, int iParentCategoryId, int iSectionId)
        {
            try
            {
                RecordCount = LegoWeb.BusLogic.Categories.get_Search_Count(iCategoryId,iParentCategoryId,iSectionId);
        ...
        public DataTable get_Search_Current_Page(int iCategoryId, int iParentCategoryId, int iSectionId, string sTabChars)
        {
            try
            {
                ...
                retData = LegoWeb.BusLogic.Categories.get_Search_Page(iCategoryId, iParentCategoryId, iSectionId, sTabChars, PageNumber, RecordsPerPage);
