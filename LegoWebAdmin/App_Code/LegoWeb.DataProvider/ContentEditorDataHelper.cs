...
namespace LegoWeb.DataProvider
{
    public class ContentEditorDataHelper:CRecord
    {
        ...
        public bool IsPublic
        {
            get
            {
                if (this.Controlfields.Controlfield("003").Value == "" || this.Controlfields.Controlfield("003").Value == "0" || this.Controlfields.Controlfield("003").Value.ToUpper() == "FALSE") return false;
                if (this.Controlfields.Controlfield("003").Value.ToUpper() == "1" || this.Controlfields.Controlfield("003").Value.ToUpper() == "TRUE") return true;
                return false;
            }
            set
            {
