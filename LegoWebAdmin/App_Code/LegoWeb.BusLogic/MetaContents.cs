...
namespace LegoWeb.BusLogic
{
    ...
    public static class MetaContents
    {
        ...
        {
            Int32 retId = 0;
            LegoWeb.DataProvider.ContentEditorDataHelper contentObj = new LegoWeb.DataProvider.ContentEditorDataHelper();
            ...
            bool bIsPublic=contentObj.IsPublic;
            ...
            if (is_META_CONTENTS_EXIST(retId))
            {
                ...
                update_META_CONTENT(retId, iCategoryId,sLeader, sLangCode, sTitle, bIsPublic, iAccessLevel, sUSER);
                isUpdate = true;
            }
            else
            { 
                //insert meta content process
                retId=insert_META_CONTENTS(iCategoryId,sLeader, sLangCode, sTitle, bIsPublic, iAccessLevel, sUSER);
                isUpdate = false;
            }
        ...
        {
            LegoWeb.DataProvider.ContentEditorDataHelper ContentObject = new LegoWeb.DataProvider.ContentEditorDataHelper();
        ...
        public static Int32 insert_META_CONTENTS(int iCATEGORY_ID,string sLEADER, string sLANG_CODE,string sMETA_CONTENT_TITLE, bool bIS_PUBLIC, int iACCESS_LEVEL, string sCREATED_USER)
        {
            string connStr = ConfigurationManager.ConnectionStrings["LEGOWEBDB"].ConnectionString;
        ...
        public static void update_META_CONTENT(int iMETA_CONTENT_ID,int iCATEGORY_ID, string sLEADER, string sLANG_CODE,string sMETA_CONTENT_TITLE, bool bIS_PUBLIC, int iACCESS_LEVEL, string sMODIFIED_USER)
        {
            string connStr = ConfigurationManager.ConnectionStrings["LEGOWEBDB"].ConnectionString;
            SqlConnection connection = new SqlConnection(connStr);
            try
        ...
        public static void remove_META_CONTENTS(int iMETA_CONTENT_ID)
        {
            string connStr = ConfigurationManager.ConnectionStrings["LEGOWEBDB"].ConnectionString;
            SqlConnection connection = new SqlConnection(connStr);
            try
        ...
        public static void moveDown_META_CONTENT(int iMetaContentID)
        {
            ...
            for (int i = 0; i < contentOrder.Rows.Count; i++)
            {
                ...
                {
                    LegoWeb.BusLogic.MetaContents.update_META_CONTENT_ORDER((Int32)contentOrder.Rows[i]["META_CONTENT_ID"], i + 1);
                }
            }
        }
        ...
        public static void publish_META_CONTENTS(int iMETA_CONTENT_ID, bool bIsPublic)
        {
            ...
            try
            {
                ...
                strCommandName = "UPDATE LEGOWEB_META_CONTENTS SET IS_PUBLIC=@_IS_PUBLIC WHERE META_CONTENT_ID=@_META_CONTENT_ID";
                objCommand = new SqlCommand(strCommandName, connection);
                objCommand.CommandType = CommandType.Text;
                //Set the Parameters
