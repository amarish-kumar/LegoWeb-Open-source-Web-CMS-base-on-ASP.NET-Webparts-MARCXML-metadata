...
namespace LegoWeb.BusLogic
{
    ...
    public static class Categories
    {
        ...
        public static void addUpdate_CATEGORY(int iCATEGORY_ID, int iPARENT_CATEGORY_ID,int iSECTION_ID, string sCATEGORY_VI_TITLE, string sCATEGORY_EN_TITLE, string sCATEGORY_TEMPLATE_NAME, string sCATEGORY_IMAGE_URL,int iMENU_ID,bool bIsPublic, int iAdminLevel, string sAdminRoles)
        {
            string connStr = ConfigurationManager.ConnectionStrings["LEGOWEBDB"].ConnectionString;
        ...
        public static void moveDown_CATEGORY(int iCategoryID)
        {
            ...
            for (int i = 0; i < catOrder.Rows.Count; i++)
            {
                ...
                {
                    LegoWeb.BusLogic.Categories.update_CATEGORY_ORDER((Int32)catOrder.Rows[i]["CATEGORY_ID"], i + 1);
                }
            }
        }
