<%@ Page Language="C#" MasterPageFile="LegoWebAdmin.master" AutoEventWireup="true" CodeFile="MetacontentManagerTree.aspx.cs" Inherits="MetacontentManagerTree" Title="Untitled Page" %>
...
<%@ Register src="LgwUserControls/MetacontentManagerTree.ascx" tagname="MetacontentManagerTree" tagprefix="uc3" %>
	  ...
	  <div class="clr"></div>
		...
		<div id="element-box">
			...
			<div class="m">                           
                            ...
                            <uc3:MetacontentManagerTree ID="MetacontentManagerTree1" runat="server" /> 																
