...
/*
	UPGRADE DATABASE form oldversion to LEGOWEB 1.0 release 29-20-2011
*/

--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'CATEGORY_ALIAS')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD CATEGORY_ALIAS nvarchar(100)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'ADMIN_LEVEL')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD ADMIN_LEVEL smallint NOT NULL default(0)	
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'ADMIN_ROLES')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD ADMIN_ROLES nvarchar(250) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'SEO_TITLE')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD SEO_TITLE nvarchar(100) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'SEO_DESCRIPTION')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD SEO_DESCRIPTION nvarchar(255) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'SEO_KEYWORDS')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD SEO_KEYWORDS nvarchar(255) default(NULL)
--END
--
--IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'IS_PUBLIC')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS DROP COLUMN IS_PUBLIC
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'RECORD_STATUS')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS ADD RECORD_STATUS smallint NOT NULL default(1)
--END
--
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'LEADER')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS ADD LEADER nvarchar(24) default(N'                        ')
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'LOCAL_CODE')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS ADD LOCAL_CODE nvarchar(30) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'META_CONTENT_ALIAS')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS ADD META_CONTENT_ALIAS nvarchar(255) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_META_CONTENTS' AND COLUMN_NAME = 'IMPORTANT_LEVEL')
--BEGIN
--   ALTER TABLE LEGOWEB_META_CONTENTS ADD IMPORTANT_LEVEL smallint NOT NULL default(0)
--END
--
--IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_MENU_TYPES' AND COLUMN_NAME = 'MENU_TYPE_TITLE')
--BEGIN
--	EXEC sp_rename
--		@objname = 'LEGOWEB_MENU_TYPES.MENU_TYPE_TITLE',
--		@newname = 'MENU_TYPE_VI_TITLE',
--		@objtype = 'COLUMN'
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_MENU_TYPES' AND COLUMN_NAME = 'MENU_TYPE_EN_TITLE')
--BEGIN
--   ALTER TABLE LEGOWEB_MENU_TYPES ADD MENU_TYPE_EN_TITLE nvarchar(255) default(NULL)
--END
--
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_COMMON_PARAMETERS' AND COLUMN_NAME = 'PARAMETER_TYPE')
--BEGIN
--   ALTER TABLE LEGOWEB_COMMON_PARAMETERS ADD PARAMETER_TYPE smallint NOT NULL default(0)
--END
--
----expand column size
--
--ALTER TABLE LEGOWEB_MENUS ALTER COLUMN MENU_LINK_URL nvarchar(250)
--
--GO
----update 10-03-2012
--IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.COLUMNS
--WHERE TABLE_NAME = 'LEGOWEB_CATEGORIES' AND COLUMN_NAME = 'SORT_CONTENT_BY')
--BEGIN
--   ALTER TABLE LEGOWEB_CATEGORIES ADD SORT_CONTENT_BY smallint NOT NULL default(1)
--END
--GO
--LEGOWEB_SECTIONS
	  ...
	  begin    
	     ...
	     begin    
			...
			set
				...
				MENU_ID=@_MENU_ID,
				SORT_CONTENT_BY=@_SORT_CONTENT_BY,
...
BEGIN
	...
	IMPORTANT_LEVEL=@_IMPORTANT_LEVEL
...
BEGIN
	...
	IF(@_SECTION_ID IS NULL)
	BEGIN
		SELECT @_SORT_CONTENT_BY = SORT_CONTENT_BY FROM LEGOWEB_CATEGORIES WHERE CATEGORY_ID=@_ROOT_CATEGORY_ID
	END;
	WITH hierarchy
	AS
	(
	...
	SELECT TOP(@_SELECT_ROW_NUMBER) LEGOWEB_META_CONTENTS.*,hierarchy.CATEGORY_ID,hierarchy.CATEGORY_VI_TITLE,hierarchy.CATEGORY_EN_TITLE 
...
CREATE procedure sp_LEGOWEB_MENUS_ADDUPDATE
		...
		@_MENU_LINK_URL nvarchar(250)=NULL,
...
/****** Object:  StoredProcedure [dbo].[sp_LEGOWEB_USER_FILES_INSERT]    Script Date: 01/15/2010 10:59:33 ******/
if exists (select * from sysobjects where id = object_id('dbo.sp_LEGOWEB_USER_FILES_INSERT') and sysstat & 0xf = 4)   drop procedure dbo.sp_LEGOWEB_USER_FILES_INSERT    
GO
CREATE procedure [dbo].[sp_LEGOWEB_USER_FILES_INSERT]
	@_USER_FILE_NAME nvarchar (50),
	@_PHYSICAL_PATH nvarchar (250),
	@_FORUM_POST_ID [int],
	@_UPLOAD_USER nvarchar (30),
	@_FILE_ID int OUTPUT
as
BEGIN
	insert into LEGOWEB_USER_FILES
	(
		USER_FILE_NAME,
		PHYSICAL_PATH,
		FORUM_POST_ID,
