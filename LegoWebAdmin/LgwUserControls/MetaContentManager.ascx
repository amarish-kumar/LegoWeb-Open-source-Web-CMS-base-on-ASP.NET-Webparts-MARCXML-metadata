<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MetaContentManager.ascx.cs" Inherits="LgwUserControls_MetaContentManager" %>
...
<table width="100%" cellpadding="0" cellspacing="2">
    <tr>
		...
		<legend><%=Resources.strings.ContentStructure_Text%></legend>		
		<asp:dropdownlist ID="dropSections" runat="server" AutoPostBack="true" OnSelectedIndexChanged="dropSections_SelectedIndexChanged"></asp:dropdownlist>
		<br />
            ...
            <table class="adminlist" cellspacing="1">   			
				<asp:repeater id="metaContentManagerRepeater" runat="server" OnItemCommand="metaContentManagerDataCommand" OnItemDataBound="metaContentManagerItemDataBound">
                            ...
                            <tr class="row0">                            
                                ...
                                <td align="center">          
                                 <asp:Image ID="imgPublic" runat="server" SkinID="Tick" Visible='<%#(bool)(DataBinder.Eval(Container.DataItem, "RECORD_STATUS").ToString()=="1")%>'/>  
                                 <asp:Image ID="imgPending" runat="server" SkinID="Stop" Visible='<%#(bool)(DataBinder.Eval(Container.DataItem, "RECORD_STATUS").ToString()=="0")%>'/>  
                                 <asp:Image ID="imgDelete" runat="server" SkinID="Deleted" Visible='<%#(bool)(DataBinder.Eval(Container.DataItem, "RECORD_STATUS").ToString()=="-1")%>'/>  
                                </td>
                                <td align="left">                                
                                <%# DataBinder.Eval(Container.DataItem, "ORDER_NUMBER")%>                                
                                </td>                                                                
                                <td align="left">                                
                                <%# DataBinder.Eval(Container.DataItem, "CATEGORY_" + System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName.ToUpper() + "_TITLE")%>                                
                                </td>                                                                                                                                                                     
                                <td align="left">                                
							...
							<AlternatingItemTemplate>
							 <tr class="row1">
                                ...
                                <td align="center">          
                                 <asp:Image ID="imgIsPublic" runat="server" SkinID="Tick" Visible='<%#(bool)(DataBinder.Eval(Container.DataItem, "RECORD_STATUS").ToString()=="1")%>'/>  
                                 <asp:Image ID="imgIsNotPublic" runat="server" SkinID="Stop" Visible='<%#(bool)(DataBinder.Eval(Container.DataItem, "RECORD_STATUS").ToString()=="0")%>'/>  
                                </td>
                                <td align="left">                                
                                <%# DataBinder.Eval(Container.DataItem, "ORDER_NUMBER")%>                                
                                </td>                                                                
