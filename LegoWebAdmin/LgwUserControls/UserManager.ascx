<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UserManager.ascx.cs" Inherits="LgwUserControls_UserManager" %>
<%@Register TagPrefix="CC" Namespace="LegoWebAdmin.Controls"%>
<table width="100%" cellpadding="2" cellspacing="2">
<tbody>
<tr>
<td align="right" valign="middle" style="width:250px"><font color="gray"><i><%=Resources.strings.UserAccountFilterGuide_Text %></i></font></td>
<td align="right" valign="middle" style="width:80px"><b><%=Resources.strings.UserName_Text %> </b></td>
...
<td align="right" valign="middle" style="width:60px"><b><%=Resources.strings.Email_Text %></b></td>
...
<td align="right" valign="middle" style="width:60px"><b><%=Resources.strings.Role_Text %></b></td>
...
<td align="right" valign="middle">
   <asp:Button ID="btnReset" class="searchbutton" runat="server" Text="Reset" onclick="btnReset_Click" />  <asp:Button ID="btnSearch" class="searchbutton" runat="server" Text="Search" onclick="btnSearch_Click" />
</td>
</tr>
</tbody>
</table>
	...
	<table class="adminlist" cellspacing="1">   									
					<asp:repeater id="userManagerRepeater" runat="server" OnItemCommand="userManagerDataCommand" OnItemDataBound="userManagerItemDataBound">
							...
							<th class="title"><%=Resources.strings.Email_Text %></th>
							<th class="title"><%=Resources.strings.Note_Text %></th>
							<th class="title"><%=Resources.strings.IsApproved_Text %></th>
							<th class="title"><%=Resources.strings.IsActived_Text %></th>
							<th class="title"><%=Resources.strings.Created_Text %></th>
							<th class="title"><%=Resources.strings.LastAction_Text %></th>
							<th class="title"><%=Resources.strings.IsOnline_Text %></th>
							</tr>
							</thead>
							<tbody>
							</HeaderTemplate>
