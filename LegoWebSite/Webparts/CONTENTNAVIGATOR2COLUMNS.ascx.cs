...
/// display 2 colums index column and content column
/// </summary>
public partial class Webparts_CONTENTNAVIGATOR2COLUMNS :WebPartBase
{
    ...
    public Webparts_CONTENTNAVIGATOR2COLUMNS()
    {
        this.Title = "CONTENT NAVIGATOR WITH ORDER NUMBER COLUMN";
    }
