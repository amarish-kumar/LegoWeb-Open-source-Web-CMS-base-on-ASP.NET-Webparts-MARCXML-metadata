...
/// parameters:
/// meta_content_id: id of meta content record, if set display specified record 
...
public partial class Webparts_CONTENTVIEWER: WebPartBase
{
    ...
    public Webparts_CONTENTVIEWER()
    {
        this.Title = "CONTENT VIEWER";
    }
    ...
    private int discover_content_id()
    {
        ...
        if (_meta_content_id == 0)
        {
            ...
            if (categoryid > 0)
            {
                DataTable top1Data = LegoWebSite.Buslgic.MetaContents.get_TOP_CONTENTS_OF_CATEGORY(categoryid, 1, System.Threading.Thread.CurrentThread.CurrentUICulture.TwoLetterISOLanguageName.ToLower());
