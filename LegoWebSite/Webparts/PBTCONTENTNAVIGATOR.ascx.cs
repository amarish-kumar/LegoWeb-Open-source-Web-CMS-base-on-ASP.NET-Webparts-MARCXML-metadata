...
/// </summary>
public partial class Webparts_PBTCONTENTNAVIGATOR :WebPartBase
{
	...
	private string _template_name = "lgwdsp_colthumbtitlesummary";
    private int _page_size = 10;
    private string _default_post_page = null;
	
    public Webparts_PBTCONTENTNAVIGATOR()
    {
        this.Title = "CONTENT PAGE NAVIGATOR";
    }
        ...
        this.litCatNaviContent.Text = LegoWebSite.Buslgic.Categories.get_NavigatePath(category_id, Request.Url.AbsoluteUri);                            
            ...
            ViewState["contentNavigatorPageCount"] = outPageCount;
                ...
                for (int i = 0; i < Data.Rows.Count; i++)
                {
                    ...
                    Data.Rows[i]["CONTENT_HTML"] = myRec.XsltFile_Transform(sTemplateFileName).Replace("{POST_URL}", postQuery.AbsoluteUri);
                }
